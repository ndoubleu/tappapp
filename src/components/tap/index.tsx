  ...
  return (
    <div className="relative w-full h-full flex flex-col gap-4 items-center">
      ...
      <div className='relative w-full h-full flex flex-col justify-between'>
        <div className='flex flex-nowrap justify-center items-center text-4xl font-bold'>
        ...
        <div className='flex flex-nowrap gap-2 justify-between items-center'>
          ...
          <div className='flex flex-nowrap gap-2 justify-between items-center text-xl bg-black p-2 bg-opacity-25 rounded-[10px] cursor-pointer'>
            <span>🚀</span>
            <span>Boost</span>
          </div>      
        </div>
        <Image src={Tap} alt="Tap" className='cursor-pointer absolute inset-0 m-auto' onClick={()=>{setCount(count+1)}}/>
      </div>
  </div>
  );
}
